...
void loop()
{
  ...
  analogWrite(led0, 120);     // posar PWM del pin 3 a 60
  ...
  analogWrite(led0, 180);     // posar PWM del pin 3 a 60
  analogWrite(led1, 120);     // posar PWM del pin 5 a 60
  ...
  analogWrite(led0, 220);     // posar PWM del pin 3 a 60
  analogWrite(led1, 180);     // posar PWM del pin 5 a 60
  analogWrite(led2, 120);     // posar PWM del pin 6 a 60
  ...
  analogWrite(led0, 240);     // posar PWM del pin 3 a 60
  analogWrite(led1, 220);     // posar PWM del pin 5 a 60
  analogWrite(led2, 180);     // posar PWM del pin 6 a 60
  analogWrite(led3, 120);     // posar PWM del pin 9 a 60
  ...
  analogWrite(led1, 240);     // posar PWM del pin 5 a 60
  analogWrite(led2, 220);     // posar PWM del pin 6 a 60
  analogWrite(led3, 180);     // posar PWM del pin 9 a 60
  analogWrite(led4, 120);     // posar PWM del pin 10 a 60
  ...
  analogWrite(led2, 240);     // posar PWM del pin 6 a 60
  analogWrite(led3, 220);     // posar PWM del pin 9 a 60
  analogWrite(led4, 180);     // posar PWM del pin 10 a 60
  analogWrite(led5, 120);     // posar PWM del pin 11 a 60
  ...
  analogWrite(led3, 240);     // posar PWM del pin 9 a 60
  analogWrite(led4, 220);     // posar PWM del pin 10 a 60
  analogWrite(led5, 180);     // posar PWM del pin 11 a 60
  ...
  analogWrite(led4, 240);     // posar PWM del pin 10 a 60
  analogWrite(led5, 220);     // posar PWM del pin 11 a 60
  ...
  analogWrite(led5, 240);     // posar PWM del pin 11 a 60
